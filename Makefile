...
LIBDIR2 = ../../lib/SDL2_mixer-2.0.4/build/.libs/
...
$(PROGRAM):	$(OBJECTS)
	$(CXX) -o $(PROGRAM) $(OBJECTS) -L$(LIBDIR) -L$(LIBDIR2) `$(WX_CONFIG) --libs` -lpthread -lsndfile -lSDL2 -lSDL2_mixer -framework CoreMidi -framework CoreAudio -framework CoreFoundation
